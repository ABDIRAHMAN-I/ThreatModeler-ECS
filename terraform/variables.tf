...
variable "certificate_arn" {
  ...
  default     = "arn:aws:acm:eu-west-2:992382674979:certificate/b40264cc-cf86-4cab-892d-6c41219358c0" # edit
}
...
variable "task_role_arn" {
  ...
  type        = string
  default     = "arn:aws:iam::977098994448:user/Abdirahman-DevOps" 
}

variable "execution_role_arn" {
  description = "The ARN of the existing IAM execution role for ECS Task"
  type        = string
  default     = "arn:aws:iam::977098994448:user/Abdirahman-DevOps" 
}
